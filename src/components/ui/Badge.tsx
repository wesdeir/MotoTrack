...
export function CategoryBadge({ category }: { category: MaintenanceCategory }) {
  return (
    <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-white/50 border border-white/60 text-gray-600 dark:bg-white/[0.08] dark:border-white/[0.10] dark:text-gray-400">
